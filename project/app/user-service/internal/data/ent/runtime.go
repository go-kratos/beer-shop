...
import (
	...
	"github.com/go-kratos/beer-shop/project/app/user-service/internal/data/ent/schema"
...
func init() {
	...
	// server-service.DefaultCreatedAt holds the default value on creation for the created_at field.
	user.DefaultCreatedAt = userDescCreatedAt.Default.(func() time.Time)
	// userDescUpdatedAt is the schema descriptor for updated_at field.
	userDescUpdatedAt := userFields[4].Descriptor()
	// server-service.DefaultUpdatedAt holds the default value on creation for the updated_at field.
