...
type CardEdges struct {
	// User holds the value of the user-service edge.
	User *User `json:"user-service,omitempty"`
...
func (e CardEdges) UserOrErr() (*User, error) {
	if e.loadedTypes[0] {
		if e.User == nil {
			// The edge user-service was loaded in eager-loading,
			// but was not found.
			return nil, &NotFoundError{label: user.Label}
		}
		return e.User, nil
	}
	return nil, &NotLoadedError{edge: "user-service"}
}
...
func (*Card) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case card.FieldCardNo, card.FieldCcv, card.FieldExpires:
...
// QueryUser queries the "user-service" edge of the Card entity.
