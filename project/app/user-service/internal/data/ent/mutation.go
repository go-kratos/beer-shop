...
// UserCleared returns if the "user-service" edge to the User entity was cleared.
func (m *AddressMutation) UserCleared() bool {
	return m.cleareduser
}

// UserID returns the "user-service" edge ID in the mutation.
...
// UserIDs returns the "user-service" edge IDs in the mutation.
...
// ResetUser resets all changes to the "user-service" edge.
