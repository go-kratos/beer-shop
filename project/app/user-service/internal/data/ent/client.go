...
import (
	...
	"github.com/go-kratos/beer-shop/project/app/user-service/internal/data/ent/migrate"
...
// QueryUser queries the user-service edge of a Address.
...
// QueryUser queries the user-service edge of a Card.
...
// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `user-service.Hooks(f(g(h())))`.
