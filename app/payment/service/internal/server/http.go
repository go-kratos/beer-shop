...
func NewHTTPServer(c *conf.Server, logger log.Logger, tp *tracesdk.TracerProvider, s *service.PaymentService) *http.Server {
	...
	srv.HandlePrefix("/", v1.NewPaymentHandler(s, m))
	return srv
}
