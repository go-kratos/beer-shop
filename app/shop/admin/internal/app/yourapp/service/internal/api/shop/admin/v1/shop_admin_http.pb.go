...
func RegisterShopAdminHTTPServer(s *http.Server, srv ShopAdminHTTPServer) {
	r := s.Route("/")
	r.POST("/admin/v1/login", _ShopAdmin_Login1_HTTP_Handler(srv))
	r.POST("/admin/v1/logout", _ShopAdmin_Logout1_HTTP_Handler(srv))
	r.GET("/admin/v1/catalog/beers", _ShopAdmin_ListBeer1_HTTP_Handler(srv))
	...
	r.GET("/admin/v1/orders", _ShopAdmin_ListOrder1_HTTP_Handler(srv))
...
func _ShopAdmin_Login1_HTTP_Handler(srv ShopAdminHTTPServer) func(ctx http.Context) error {
...
func _ShopAdmin_Logout1_HTTP_Handler(srv ShopAdminHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in LogoutReq
		if err := ctx.Bind(&in); err != nil {
			return err
...
func _ShopAdmin_ListBeer1_HTTP_Handler(srv ShopAdminHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in ListBeerReq
...
func _ShopAdmin_ListOrder1_HTTP_Handler(srv ShopAdminHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in ListOrderReq
		if err := ctx.BindQuery(&in); err != nil {
			return err
